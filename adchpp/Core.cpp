...
void Core::init() {
	...
	//lm->log("core", "Core initialized"); @todo logfile path setting isn't processed yet so this may litter log files to unwanted places, see L#907372		lm->log("core", "Core initialized");
